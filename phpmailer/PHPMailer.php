 ...
 *
 * @author    Marcus Bointon (Synchro/coolbru) <plugins@synchromedia.co.uk>
...
class PHPMailer
{
    ...
    public function setLanguage($langcode = 'en', $lang_path = '')
    {
        ...
        $foundlang = true;
        $lang_file = $lang_path . 'plugins.lang-' . $langcode . '.php';
        ...
        if (array_key_exists(2, $images)) {
            ...
            foreach ($images[2] as $imgindex => $url) {
                ...
                if (preg_match('#^data:(image/(?:jpe?g|gif|png));?(base64)?,(.+)#', $url, $match)) {
                    ...
                    $cid = substr(hash('sha256', $data), 0, 32) . '@plugins.0'; // RFC2392 S 2
                ...
                if (// Only process relative URLs if a basedir is provided (i.e. no absolute local paths)
                    ...
                    // RFC2392 S 2
                    $cid = substr(hash('sha256', $url), 0, 32) . '@plugins.0';
                    if (strlen($basedir) > 1 && '/' !== substr($basedir, -1)) {
                        $basedir .= '/';
                    }
